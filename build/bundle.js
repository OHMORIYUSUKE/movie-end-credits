...
;// ./src/generated/credits.json
const credits_namespaceObject = /*#__PURE__*/JSON.parse('{"V":[{"title":"一般参加","names":["ShinpeiTakano","tokumei-san","Okunichiyou","ジャイロ","seri","やすやけ","ueshiman21","Kenta Sato","oda13","慕狼ゆに","pawn","reodon","Tkoya","BannoTakuya","ため","nicozetsche","itojum","遠藤ヒズミ","infixer","hibiki03","ENDO Masaki","さわら(Hiroaki Ogasawara)","sa1monICs","myblackcat7112","rymiyamoto/パンダム","nakadate00","yamii","くろむ","ruribou"]},{"title":"登壇者","names":["Subroh Nishikori","まことのこと研究所","kubosho","ナカミチ","おだかとしゆき","ryugen04","山本 一将","しゅういちろ","kanami-","マグロ","TDD野郎","小泉岳人","dam","u-Hoshi","mazrean","chango","イットリウム","goro","ムツミックス","こまもか","パウリ","くさば","ニシ サダオミ","オクラ","nikkie","キタジー"]},{"title":"スタッフ","names":["nikkie","うーたん","キタジー（kitaji0306）","くさば","こうの","こまもか","マグロ","りんりん","ヲクラ"]}],"u":{"ブロンズ":["オクラ","h.kono","キタジー（kitaji0306）"],"シルバー":["くさば"],"ゴールド":["やすやけ","ke-ta-f","慕狼ゆに"]}}');
;// ./src/generated/video-config.json
const video_config_namespaceObject = /*#__PURE__*/JSON.parse('{"Qp":6903,"uU":30,"YN":15,"J7":60,"VI":"logo/logo.svg"}');
;// ./src/Composition.tsx
...
const MyComposition = () => {
  ...
  const [musicData, setMusicData] = (0,react.useState)(null);
  const [logoUrl, setLogoUrl] = (0,react.useState)(null);
  const [handle] = (0,react.useState)(() => (0,esm.delayRender)());
  const frame = (0,esm.useCurrentFrame)();
  const { height, durationInFrames, fps } = (0,esm.useVideoConfig)();
  const DELAY_FRAMES = video_config_namespaceObject.YN ?? 0.5 * fps;
  const END_DELAY_FRAMES = video_config_namespaceObject.J7 ?? 2 * fps;
  (0,react.useEffect)(() => {
    Promise.all([
    ...
    ]).then(([allPhotos, allMusic, logo]) => {
      const finalPhotos = allPhotos.filter((p) => p.selected).sort((a, b) => a.timestamp - b.timestamp);
  ...
  const activeDurationFrames = (0,react.useMemo)(() => {
    return durationInFrames - DELAY_FRAMES - END_DELAY_FRAMES;
  }, [durationInFrames, DELAY_FRAMES, END_DELAY_FRAMES]);
  const musicDurationFrames = (0,react.useMemo)(() => {
    if (musicData == null ? void 0 : musicData.duration) {
      return Math.floor(musicData.duration * fps);
    }
    return activeDurationFrames;
  }, [musicData, activeDurationFrames, fps]);
  const creditItems = (0,react.useMemo)(() => {
    const items = [
      ...(credits_namespaceObject.V || []).flatMap((section) => [
        { type: "header", text: section.title },
        { type: "spacer", height: 50 },
        ...section.names.map((name) => ({ type: "participant", name })),
        { type: "spacer", height: 150 }
      ]),
      { type: "spacer", height: 150 },
      { type: "header", text: "\u500B\u4EBA\u30B9\u30DD\u30F3\u30B5\u30FC" },
      { type: "spacer", height: 100 },
      ...Object.entries(credits_namespaceObject.u || {}).reverse().flatMap(([rank, names]) => [
        { type: "rank", text: rank, large: true },
        { type: "spacer", height: 40 },
        ...names.map((name) => ({ type: "sponsor", name, large: true })),
        { type: "spacer", height: 100 }
      ]),
    ...
    if (logoUrl) {
      ...
      items.push({ type: "logo", src: (0,esm.staticFile)(video_config_namespaceObject.VI || "logo/logo.svg"), height: 300 });
    }
    return items;
  }, [logoUrl]);
  ...
  const currentPhoto = (0,react.useMemo)(() => {
  ...
  const photoOpacity = (0,react.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "black", color: "white", fontFamily: "sans-serif" }, children: [
    musicData && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: DELAY_FRAMES, durationInFrames: musicDurationFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: `http://localhost:8000/api/music?id=${musicData.id}` }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", width: "50%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center", padding: "40px" }, children: currentPhoto && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Img,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", right: 0, width: "50%", height: "100%", overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `translateY(${scrollY}px)`, display: "flex", flexDirection: "column", alignItems: "center" }, children: creditItems.map((item, index) => {
      const itemHeight = getItemHeight(item);
      if (item.type === "spacer") return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { height: itemHeight } }, index);
      return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { height: itemHeight, textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "center", color: "white" }, children: [
        item.type === "staff" && /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "22px", opacity: 0.8, letterSpacing: "2px", marginBottom: "5px" }, children: item.role }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "34px", fontWeight: "bold" }, children: item.name })
        ] }),
        item.type === "header" && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "30px", fontWeight: "bold", letterSpacing: "4px", borderBottom: "1px solid white", paddingBottom: "5px", marginBottom: "15px" }, children: item.text }),
        item.type === "participant" && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "26px" }, children: item.name }),
        item.type === "rank" && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "30px", fontWeight: "bold" }, children: item.text }),
        item.type === "sponsor" && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "30px", fontWeight: "bold" }, children: item.name }),
        item.type === "logo" && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: item.src, style: { height: "120px", width: "auto", display: "block", margin: "0 auto" } })
      ] }, index);
    }) }) })
  ] });
};
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      ...
      calculateMetadata: async () => {
        const handle = (0,esm.delayRender)("Fetching music duration...");
        try {
          const res = await fetch("http://localhost:8000/api/music");
          const allMusic = await res.json();
          const activeMusic = allMusic.find((m) => m.active) || allMusic[0];
          const fps = video_config_namespaceObject.uU || 30;
          const startDelay = video_config_namespaceObject.YN || 0;
          const endDelay = video_config_namespaceObject.J7 || 0;
          const musicDurationSec = activeMusic == null ? void 0 : activeMusic.duration;
          if (!musicDurationSec) {
            console.warn("Music duration not found in API, using fallback from config");
            (0,esm.continueRender)(handle);
            return {
              durationInFrames: video_config_namespaceObject.Qp
            };
          }
      ...
      fps: video_config_namespaceObject.uU,
      width: 1280,
      height: 720
    }
  ) });
